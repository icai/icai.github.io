function do_js_beautify() {
    ...
    js_source = document.getElementById('pcontent').value.replace(/^\s+/, '');
    ...
    if (js_source && js_source.charAt(0) === '<') {
        document.getElementById('pcontent').value = style_html(js_source, tabsize, tabchar, 80)
    } else {
        document.getElementById('pcontent').value = js_beautify(js_source, tabsize, tabchar)
    }
    document.getElementById('beautify').disabled = false;
    return false
}
function pack_js(base64) {
    var input = document.getElementById('pcontent').value;
    ...
    document.getElementById('pcontent').value = output
}
function Empty() {
    document.getElementById('pcontent').value = '';
    document.getElementById('pcontent').select()
}
function GetFocus() {
...
function unpack() {
    var p = document.getElementById('pcontent').value,
        c = p;
    var a = 5,
        x = 1;
    while (x < a) {
    ...
    document.getElementById('pcontent').value = c
}

...
<div class="main">
	...
	<footer>
		<p>&copy; Since 2012 <a href="http://github.com/icai" target="_blank">github.com/icai</a></p>
	</footer>
</div>

<side>
	<h2><a href="/">{{ site.name }}</a><a href="/feed.xml" class="feed-link" title="Subscribe"><img src="/images/feed-icon-16x16.png" alt="RSS feed" /></a></h2>
	<nav class="block">
		<ul>
	...
	<div class="block block-thank">
		...
		<p>
			...
			<a href="https://github.com/mojombo/SimpleGray" target="_blank">SimpleGray</a>
		</p>
	</div>
</side>
